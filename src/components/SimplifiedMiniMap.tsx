...
import { Sparkles, Star, Heart, Shield, Sun } from "lucide-react";
import {
  calculateLifePath,
  calculateExpression,
  calculateSoul,
  ...
  return (
    ...
    >
      ...
      <p className="text-xs text-muted-foreground mt-4 text-center italic">
        Questa è un'anteprima semplificata. Genera, dal menu a sinistra la Mappa Numerologica completa per un'analisi approfondita! ✨
      </p>
    </motion.section>
  );
};
